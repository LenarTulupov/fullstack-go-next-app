...
export default function Card({
  ...
  const [sizeChartModal, setSizeChartModal] = useState<boolean>(false);
  const [selectSizeModal, setSelectSizeModal] = useState<boolean>(false);

  // const handleAddToCartClick = () => {
  //   setAddToCartClicked(p => !p)
  ...
  return (
    <div className={styles.card}>
      ...
      {currentProduct && addToCartClicked && (
        <Modal isModalOpened={addToCartClicked}>
          <div>
