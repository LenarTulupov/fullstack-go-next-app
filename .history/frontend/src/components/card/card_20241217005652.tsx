  ...
  <Modal isModalOpened={!!currentProduct}>
    ...
    >
      <Button
        variant="black"
        onClick={() => {
          setIsSizeSelectModalOpen(true);
          handleCurrentProduct(null);
        }}
      >
        Select Size
      </Button>
...
{isSizeSelectModalOpen && (
  <Modal isModalOpened={isSizeSelectModalOpen}>
    <SizeChartContent
      product={currentProduct}
      onClose={() => setIsSizeSelectModalOpen(false)}
      onSizeSelected={(size) => {
        handleAddedToCart(size);
        setIsSizeSelectModalOpen(false);
      }}
    />
  </Modal>
)}
