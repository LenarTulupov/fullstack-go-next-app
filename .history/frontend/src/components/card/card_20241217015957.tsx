  ...
  return (
    <div className={styles.card}>
      ...
      {currentProduct && quickViewModal && (
        <Modal isModalOpened={quickViewModal} onClose={closeQuickView}>
          <ProductContent product={currentProduct} modal>
            <Button onClick={openSizeChart}>View Size Chart</Button>
          </ProductContent>
        </Modal>
      )}
      ...
      {/* Size Chart Modal */}
      {sizeChartModal && (
        <Modal isModalOpened={sizeChartModal} onClose={() => setSizeChartModal(false)}>
          <div>Size Chart Content Here</div>
        </Modal>
      )}

      {/* Select Size Modal */}
      {currentProduct && selectSizeModal && (
        <Modal isModalOpened={selectSizeModal} onClose={closeSelectSizeModal}>
          <div>
            <h3>Select Size</h3>
