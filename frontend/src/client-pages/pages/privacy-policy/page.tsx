    ...
    <div className={styles['privacy-policy']}>
      <Container>
        <div className={styles['privacy-policy__content']}>
          <Title weight='bold' className={styles['main-title']}>PRIVACY STATEMENT</Title>
          <section className={styles.section}>
            <Title>SECTION 1 - WHAT DO WE DO WITH YOUR INFORMATION?</Title>
          ...
          <section className={styles.section}>
            <Title>SECTION 5 - THIRD-PARTY SERVICES</Title>
            <div className={styles.text}>
          ...
          <section className={styles.section}>
            <Title>SECTION 6 - SECURITY</Title>
            <div className={styles.text}>
          ...
          <section className={styles.section}>
            <Title>SECTION 8 - AGE OF CONSENT</Title>
            <div className={styles.text}>
            By using this site, you represent that you are at least the age of majority in your state or province of residence, or that you are the age of majority in your state or province of residence and you have given us your consent to allow any of your minor dependents to use this site.
            </div>
          </section>
          <section className={styles.section}>
            <Title>SECTION 9 - CHANGES TO THIS PRIVACY POLICY</Title>
            <div className={styles.text}>
            We reserve the right to modify this privacy policy at any time, so please review it frequently. Changes and clarifications will take effect immediately upon their posting on the website. If we make material changes to this policy, we will notify you here that it has been updated, so that you are aware of what information we collect, how we use it, and under what circumstances, if any, we use and/or disclose it. If our store is acquired or merged with another company, your information may be transferred to the new owners so that we may continue to sell products to you.
            </div>
          </section>
          <section className={styles.section}>
            <Title>QUESTIONS AND CONTACT INFORMATION</Title>
            <div className={styles.text}>
            If you would like to: access, correct, amend or delete any personal information we have about you, register a complaint, or simply want more information contact our Privacy Compliance Officer at hi@simpleretro.com.
            </div>
          </section>
        </div>
      </Container>
